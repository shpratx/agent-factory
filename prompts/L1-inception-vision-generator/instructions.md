...
GOAL:
  ...
  - Document uploaded to /<execution-id>/vision-doc/
...
INSTRUCTIONS:
  ...
  Input Ingestion:
  - Source: direct_input (text idea) + domain KB (attached at runtime)
  ...
  - execution_id: auto-generated UUID for this execution (used in artifact path and output)
  ...
  8. Upload markdown to Azure Blob at /<execution-id>/vision-doc/vision-<product-name>.md
...
EXPECTED OUTPUT:
  ...
  Schema:
  {
    ...
    "execution_id": "<auto-generated-uuid>",
    "status": "success",
    "content": {
