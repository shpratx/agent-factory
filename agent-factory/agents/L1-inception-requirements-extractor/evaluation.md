...
|-----------|-----------|--------|
| IDs sequential | FR-01, FR-02... / NFR-01... / CON-01... / ASM-01... / GAP-01... | Automated: pattern check |
...
| No empty required fields | id, title, description populated | Automated: null check |
...
| Categorisation | FRs, NFRs, constraints, assumptions correctly separated | Mostly correct, 1 miscategorised | Several miscategorised | Categories confused |
...
- [ ] Execution summary includes category counts and coverage assessment
