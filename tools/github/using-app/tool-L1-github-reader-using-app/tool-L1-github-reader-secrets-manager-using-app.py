...
Credentials
-----------
    APP_ID, CLIENT_ID, and PRIVATE_KEY are retrieved from AWS Secrets Manager
    at import time (see AWSSecretReaderPodIdentity below) and never stored in
    this file.
...
#     that installed the App. Keeping it in Secrets Manager rather than in
#     code is what prevents that.
