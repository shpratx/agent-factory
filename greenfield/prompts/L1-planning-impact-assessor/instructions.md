...
INSTRUCTIONS:
  ...
  **Technical touch check (CMDB, configuration-item grain):** {one row per
  ...
  F or items, carry every field in full — do NOT condense; these facts are already short and atomic, same principle as L1-requirements-elicitor's FR statements
