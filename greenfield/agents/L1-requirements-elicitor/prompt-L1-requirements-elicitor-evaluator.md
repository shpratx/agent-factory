reportable
Independent Quality Evaluator - re-checks requirement quality against ISO, IEC, IEEE 29148, independently of the generator own self-check
...
- Source 2: Retrieve the evaluation file from blob storage using the attached blob storage reader tool, with the tool parameter:
​folder_name = "requirements-documents"
file_names = ["requirements-elicitor-evaluation.md"]​
