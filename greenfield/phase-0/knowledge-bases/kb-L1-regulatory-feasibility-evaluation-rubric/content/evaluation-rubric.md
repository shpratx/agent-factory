<!--
kb-L1-regulatory-feasibility-evaluation-rubric · content · evaluation-rubric.md
Layer: L1. Runtime copy of L1-vision-regulatory-feasibility-checker/evaluation.md,
consumed by L1-vision-regulatory-feasibility-checker-evaluator. Source of truth
is evaluation.md — keep this file in sync with it, do not edit independently.
-->

# Evaluation Rubric — L1-vision-regulatory-feasibility-checker
...
---
*Source of truth: L1-vision-regulatory-feasibility-checker/evaluation.md — update both together, never let this KB drift from it.*
